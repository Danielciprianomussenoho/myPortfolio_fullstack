              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex justify-between mt-auto pt-4 border-t border-gray-800">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-4 py-2 bg-gray-800 text-gray-200 rounded-lg hover:bg-gray-700 transition-colors duration-300 flex items-center gap-2"
                  >
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-lg hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 flex items-center gap-2"
                  >
