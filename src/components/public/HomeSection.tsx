...
return (
  ...
  >
    <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12">
      {/* Profile Information - Adicionei overflow-hidden e flex-shrink */}
      <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-6 overflow-hidden min-w-0">
        <motion.h1 
          initial={{ y: -20 }}
          whileInView={{ y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.2 }}
          className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-500 dark:from-emerald-300 dark:to-teal-400 leading-tight break-words"
        >
          {homeData.name}
        </motion.h1>
        ...
        <motion.h2 
          ...
          className="text-xl md:text-2xl font-semibold text-gray-600 dark:text-gray-300 break-words"
        >
          {homeData.title}
        </motion.h2>
        ...
        <motion.p 
          ...
          className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-line max-w-2xl break-words"
        >
      ...
      {/* Profile Picture - Adicionei flex-none para evitar que seja comprimido */}
      <motion.div 
