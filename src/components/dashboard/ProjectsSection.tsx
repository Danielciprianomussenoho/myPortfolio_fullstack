...
//             {/* Upload de Imagem do Projeto - CORRIGIDO */}
//             <div>
...
//               {/* Preview da imagem do projeto - USANDO <img> */}
//               {(previewImages[index] || card.image) && (
//                 <div className="mt-2">
...
//                       onError={(e) => {
//                         console.error("Erro ao carregar imagem do projeto:", previewImages[index] || card.image);
...
//               {/* Link para imagem atual (se existir) */}
